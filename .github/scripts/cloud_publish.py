...
TAG_MAP = {
    "host": "HOST Rules",
    "expir": "HOST Rules",
    "registration": "HOST Rules",
    "inspector": "HOST Rules",
    "regulation": "HOST Rules",
    "insurance": "Insurance",
    "insurer": "Insurance",
    "coverage": "Insurance",
    "non-renew": "Insurance",
    ...
    "quote": "Cost Guide",
    "remov": "Tank Removal",
    "disposal": "Tank Removal",
    "decommission": "Tank Removal",
    "heat pump": "Tank Removal",
    "conversion": "Tank Removal",
    "replace": "Tank Replacement",
    "replacement": "Tank Replacement",
    "lifespan": "Tank Replacement",
    "how long": "Tank Replacement",
    "new tank": "Tank Replacement",
    "leak": "Leaks & Spills",
    "spill": "Leaks & Spills",
    "oil smell": "Leaks & Spills",
    "contamina": "Leaks & Spills",
    "wet spot": "Leaks & Spills",
    "fibreglass": "Tanks 101",
    "fiberglass": "Tanks 101",
    "roth": "Tanks 101",
    "granby": "Tanks 101",
    "double-wall": "Tanks 101",
    "double wall": "Tanks 101",
    "vent": "Tanks 101",
    "whistle": "Tanks 101",
    "gauge": "Tanks 101",
    ...
    "closing": "Buying a Home",
    "lawyer": "Buying a Home",
}
...
def make_nav_title(title):
    ...
    nav = re.sub(r'\s*[-–—]\s*Harbour Tank Co.*$', '', nav)
    nav = re.sub(r'\s*\(20\d{2}.*?\)', '', nav)
    nav = re.sub(r"\s*St\. John's:?\s*", ' ', nav).strip()
    if len(nav) <= 30:
        return nav
    words = nav.split()
    result = ''
...
def clean_body_links(body):
    body = re.sub(r'https?://harbourtank\.ca/', '/', body)
...
def convert_and_write(draft_path, output_path, publish_date, slug):
    ...
    canonical = f'https://harbourtank.ca/blog/{slug}/'
